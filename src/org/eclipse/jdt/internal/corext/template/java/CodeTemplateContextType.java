...
import org.eclipse.jface.text.templates.HYTemplateVariables;
...
public class CodeTemplateContextType extends TemplateContextType {
	...
	public CodeTemplateContextType(String contextName) {
        ...
        // ZhengWei(HY) Add 2014-11-07
        addResolver(new HYTemplateVariables.DateYMS());
        addResolver(new HYTemplateVariables.Author());
        addResolver(new HYTemplateVariables.SuperComment());
